...
namespace SnappyDOTNET
{
    ...
    /// </summary>
    public class SnappyDOTNETStream : Stream
    {
        Stream Stream;
        ...
        /// </param>
        public SnappyDOTNETStream(Stream stream, CompressionMode mode) : this(stream, mode, false) { }
        ...
        public SnappyDOTNETStream(Stream stream, CompressionMode mode, bool leaveOpen)
        {
            Stream = stream;
            Mode = mode;
            LeaveOpen = leaveOpen;
